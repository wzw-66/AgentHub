...
export default function Sidebar({ activeConversationId, onSelectConversation }: SidebarProps) {
  ...
  const { conversations, isLoadingConversations, createConversation, contacts, fetchContacts, fetchConversations, togglePinConversation, toggleArchiveConversation } = useChat();
  const { t } = useI18n();
